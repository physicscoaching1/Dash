...
tabstyle = {'background-color': 'White', 'border-bottom': '1pt solid Blue'}
websitenamestyle = {'color': 'Black', 'background-color': 'White', 'font-size': '170%', 'border-bottom': '1pt solid Blue' }
...
buttonstyle = {'textAlign': 'center', 'background-color': 'White', 'border': 'none', 'font-size': '110%'}
...
app.layout = html.Div([
    ...
    html.Div(children=[html.B('GlobalInvestor')
